...
```
g++ -o bin/animations src/*.cpp -I /opt/homebrew/Cellar/sfml/2.5.1_2/inlcude -L /opt/homebrew/Cellar/sfml/2.5.1_2/lib -lsfml-graphics -lsfml-window -lsfml-system -std=c++20
```
...
```
g++ -o bin/tests tests/*.cpp src/drawShapes.cpp src/moveCircle.cpp src/moveRectangle.cpp -I /opt/homebrew/Cellar/googletest/1.13.0/include -I /opt/homebrew/Cellar/sfml/2.5.1_2/inlcude -L /opt/homebrew/Cellar/googletest/1.13.0/lib -lgtest -lgtest_main -lgmock -lgmock_main -pthread -L /opt/homebrew/Cellar/sfml/2.5.1_2/lib -lsfml-graphics -lsfml-window -lsfml-system -std=c++20
```
